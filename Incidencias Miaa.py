...
st.markdown("""
    ...
    .card-details { background-color: #0b0f17; border-top: 1px solid #1f2937; padding: 12px; border-bottom-left-radius: 12px; border-bottom-right-radius: 12px; }
...
def render_card(row, color, unique_key, con_mapa=True):
    ...
    # Usamos st.container nativo para agrupar todo dentro del mismo marco visual con fondo y borde izquierdo
    with st.container():
        st.markdown(f"""
            <div style='background: #111827; border-radius: 12px; border-left: 6px solid {color}; margin-bottom: 15px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.3);'>
                <div class='card-body'>
        ...
        if is_open:
            st.markdown(f"""
                <div style='background: #111827; border-radius: 12px; border-left: 6px solid {color}; margin-top: -10px; margin-bottom: 15px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.3);'>
