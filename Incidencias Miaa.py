...
st.markdown("""
    ...
    /* Forzar que los botones dentro de las tarjetas tengan estilo integrado */
...
def render_card(row, color, unique_key, con_mapa=True):
    ...
    # Usamos un contenedor único con borde nativo de Streamlit para asegurar que todo quede estrictamente encapsulado en la tarjeta
